    ...
    <section id="services" class="services">
        ...
        <div class="row">
          <div class="col-md-5">
            <div class="process-box process-left" data-aos="fade-right" data-aos-duration="1000">
              ...
              <div class="process-line-l" style="transform: translate(-2px,6px);">
      ...
      <div class="row d-flex justify-content-around align-items-center text-black" >
        <div class="col-12 d-flex justify-content-around align-items-center" style="min-height:300px;background-color:#f3f1f0;" >
          <p style="text-align: center;margin-bottom:0px; font-size:37px; color:#224f86;"> Rester connectés  avec vos proches tous les jours grâce<br> à CAURI Pay, sans frais.<br>
            <a class="cta-btn align-middle" href="#"> Créer votre compte </a>
          </p>
        </div>   
      </div>
      ...
      <div class="row d-flex justify-content-around align-items-center" style="min-height: 600px; background-color:#F5FFFD;"> 
        ...
        <div class="col-md-5">          
          <h2 class="h2 d-flex justify-content-around align-items-center" >
            Rechargez votre téléphone mobile pour toujours être proches de votre famille.
          </h2>
          <p class="centr">
        ...
        <div class="col-md-5"> 
          <img src="/assets/img/pay.png" style="width: 100%;height:100%;" alt="" />
        </div> 
        <div class="col-1"></div>                   
      </div>
