...
<body>
  ...
  <main id="main">
      ...
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <ol>
            ...
            <li><a href="{{url('wallets')}}">FAQ</a></li>
            <li>CAURI Wallet</li>
    ...
    <section id="services" class="services">
      ...
      <section class="our-blog p-0 m-0 bg-silver" style="padding-top: 16px !important;">
          ...
          <div class="col-md-5">
            <div class="process-box process-right" data-aos="fade-left" data-aos-duration="1000">
              ...
              <div class="col-md-7">
                ...
                <p><small>Apres la connexion vous verrez le tableau de bord </small></p>
              </div>
            </div>
            ...
            <div class="process-box process-left" data-aos="fade-right" data-aos-duration="1000">
              <div class="row">
                ...
                <div class="col-md-7">
                  ...
                  <p><small>Vous cliquez sur le menu du haut à gauche et choisissez une action à effectuer</small></p>
                </div>
              </div>
              <div class="process-line-l" style="transform: translate(-10px,5px);">
                <div class="process-point-right process-last" style="transform: translate(200px,50px);"></div>
              </div>
            </div>
            </div>
            <div class="col-md-2"></div>
        ...
        <div class=" ctad row d-flex justify-content-around align-items-center text-white" style="min-height: 80px;">
          <div class="col-auto resizeFontMobile"> 
            <span> Une question sur MYCAURI ? N’hésitez pas à nous appeler! </span>
          </div>
          <div class="col-auto">
            <a href="#">
              <button type="button" class="btn" style="width:200px; color:white; right:15px; position: relative;">+224 654 18 14 00</button>
            </a>
          </div>
        </div>
        ...
        <div class="row d-flex justify-content-around align-items-center" style="min-height: 450px; background-color:#F5FFFD;"> 
          ...
          <div class="col-md-5">          
            <h2 class="h2 d-flex justify-content-around align-items-center" >
              Continuez votre shopping, où que vous soyez.<br> Vous pouvez payer tout aussi facilement et encore plus rapidement avec CAURI Wallet.
            </h2>
            <p class="centr">
          ...
          <div class="col-md-5"> 
            <img src="/assets/img/walet.jpg" style="width: 100%;height:100%;" alt="" />
          </div> 
          <div class="col-1"></div>                    
        </div>
        ...
        <div class="row d-flex justify-content-around align-items-center" style="min-height: 500px; background-color:#F5FFFD;">
          <div class="col-1"></div> 
          <div class="col-md-5">
            <img src="/assets/img/qr.png" style="width: 100%;height:100%;" alt="" />
          </div>
          <div class="col-md-5">
            <h2 class="h2 d-flex justify-content-around align-items-center" >
              Payez sans contact avec un QR code
              Grâce à notre app, plus besoin de cash, de cartes
              ou de code PIN. Il vous suffit de scanner un QR code*.
            </h2>
          </div>
          <div class="col-1"></div>
        </div>
  ...
  <div class="row d-flex justify-content-around align-items-center text-black" >
    <div class="col-12 d-flex justify-content-around align-items-center" style="min-height:400px;background-color:#f3f1f0;" >
      <p style="text-align: center;margin-bottom:0px; font-size:35px; color:#224f86;"> Rejoignez la communauté mondiale d’utilisateurs CAURI Wallet <br> pour envoyer, dépenser et recevoir de l’argent de manière<br> sécurisée chaque jour.<br>
      <a class="cta-btn align-middle" href="{{url('contact')}}">Ouvrir un compte gratuitement</a>
      </p> 
    </div> 
  </div>
