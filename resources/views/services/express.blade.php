      ...
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <ol>
            ...
            <li><a href="{{url('expressfaq')}}">FAQ</a></li>
            <li>CAURI Express</li>
          </ol>
        </div>
      ...
      <div class="container">
        ...
        <section class="our-blog p-0 m-0 bg-silver" style="padding-top: 16px !important;">
          ...
          <div class="row">
            <div class="col-md-5">
              <div class="process-box process-left" data-aos="fade-right" data-aos-duration="1000">
                <div class="row">
                  ...
                  <div class="col-md-7">
                    <h5>Inscription</h5>
                    <p><small>Créez votre compte si vous n’en avez pas encore</small></p>
                  </div>
                </div>
            ...
            <div class="col-md-5">
              <div class="process-point-right" style="transform: translate(-2px,3px);"></div>
            </div>
          </div>
          <!-- ============ step 2 =========== -->
          <div class="row">    
            <div class="col-md-5">
              <div class="process-point-left" style="transform: translate(1px,10px);"></div>
            </div>
            <div class="col-md-2"></div>
            <div class="col-md-5">
              <div class="process-box process-right" data-aos="fade-left" data-aos-duration="1000">
                ...
                <div class="process-line-r" style="transform: translate(15px,-2px);"></div>
              </div>
            </div>
          </div>
          <!-- ============ step 3 =========== -->
            ...
            <div class="col-md-5">
              <div class="process-box process-left" data-aos="fade-right" data-aos-duration="1000">
                <div class="row">
                  ...
                  <div class="col-md-7">
                    <h5>Envoyer un colis</h5>
                    <p><small>Renseignez les informations du récepteur tout en indiquant l’adresse de ramassage et celle de la livraison. Donnez le code de livraison à la personne qui doit recevoir le colis </small></p>
                  </div>
                </div>
                <div class="process-line-l" style="transform: translate(2px,26px);"></div>
              </div>
            </div>
            <div class="col-md-2"></div>
            <div class="col-md-5">
              <div class="process-point-right" style="transform: translate(15px,-39px);"></div>
            </div>
          </div>
          <!-- ============ step 4 =========== -->
          <div class="row">
              ...
              <div class="process-box process-right" data-aos="fade-left" data-aos-duration="1000">
                <div class="row">
                  ...
                  <div class="col-md-7">
                    ...
                    <p><small>Une fois que le livreur est là saisissez le code pour vérifier si c’est la bonne personne</small></p>
                  </div>
                </div>           
              <div class="process-line-r" style="transform: translate(5px,-1px);" >
                <div class="process-point-right process-last" style="transform: translate(50px,32px);"></div>  </div>
            </div>
          </div>   
          </div>
          </div>
        ...
        <div class="row d-flex justify-content-around align-items-center text-black" >
          <div class="col-12 d-flex justify-content-around align-items-center" style="min-height:300px;background-color:#f3f1f0;" >
            <p style="text-align: center;margin-bottom:0px; font-size:35px; color:#224f86;"> Envoyez vos colis en toute sécurité partout<br> en guinée avec CAURI Express.<br>
              <a class="cta-btn align-middle" href="{{url('contact')}}"> inscrivez-vous</a>
            </p>       
          </div>        
        </div>
        ...
        <div class="row d-flex justify-content-around align-items-center" style="min-height: 450px; background-color:#F5FFFD;"> 
          ...
          <div class="col-md-5">          
            <h2 class="h2 d-flex justify-content-around align-items-center" >
              N’attendez plus, devenez livreur et gagnez de l’argent.
            </h2>
            <p class="centr">
          ...
          <div class="col-md-5"> 
            <img src="/assets/img/slide-3.png" style="width: 100%;height:100%;" alt="" />
          </div> 
          <div class="col-1"></div>                     
        </div>
        ...
        <div class="row d-flex justify-content-around align-items-center" style="min-height: 450px; background-color:#F5FFFD;"> 
          <div class="col-1"></div>
          <div class="col-md-5">  
            <img src="/assets/img/livraison.png" style="width: 100%;height:100%;" alt="" />         
          </div>         
            
          <div class="col-md-5"> 
            <h2 class="h2 d-flex justify-content-around align-items-center " >
              Votre colis est précieux pour nous, n’hésitez pas cauri express s’en charge en un temps record
            </h2>
            <p class="centr">
              <a class="cta-btn " href="#">
                Envoyer un colis 
